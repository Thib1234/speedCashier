...
namespace App\Http\Controllers\Api\StatProducts;
    ...
    public function __invoke(Request $request)
    {
        ...
        $filteredSales = $sales->map(function ($sale) {
            $filteredProducts = $sale->products->filter(function ($product) {
                return $product->category && in_array($product->category->name, ['San Bernard', 'Thermes Argos']);
            });
            ...
            $filteredSale->total_amount = $filteredProducts->sum(function ($product) {
