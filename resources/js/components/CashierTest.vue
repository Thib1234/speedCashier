    ...
    <div class="flex overflow-hidden">
        ...
        <div class="flex-1 p-5">
            <div class="grid grid-cols-4 gap-4">
                <!-- Ajoutez cette ligne -->
                <div v-for="product in products" :key="product.id" @click="addToCart(product), (searchQuery = '')"
        ...
        <div class="w-[300px] pr-4 overflow-y-scroll">
            <div class="h-16 flex items-center justify-center border-b">
                <h2 class="font-semibold">Caisse</h2>
            </div>
            <h2 class="font-bold mb-4 text-center">Panier</h2>
            <div v-if="cart.length === 0" class="text-gray-500 text-center mb-4">
                Le panier est vide.
            </div>
            <div v-else>
