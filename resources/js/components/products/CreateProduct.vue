            ...
            <div class="border-b border-gray-900/10 pb-12">
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <input inputmode="decimal" v-model="formData.price" id="price" name="price" type="number"
                                autocomplete="price"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                        </div>
                    </div>
                    <div class="sm:col-span-4">
                        <label for="pruchase_price" class="block text-sm font-medium leading-6 text-gray-900">Prix
                            d'achat HTVA</label>
                        <div class="mt-2">
                            <input inputmode="decimal" v-model="formData.purchase_price" id="pruchase_price"
                                name="pruchase_price" type="number" autocomplete="pruchase_price"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                        </div>
                    </div>
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <input inputmode="numeric" v-model="formData.stock" id="stock" name="stock" type="number"
                                autocomplete="stock"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                        </div>
                    </div>
