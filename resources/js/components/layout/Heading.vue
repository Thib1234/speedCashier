                ...
                <Popover class="relative">
                    ...
                    <transition enter-active-class="transition ease-out duration-200"
                        ...
                        <PopoverPanel
                            class="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5">
                            <div class="p-4">
                                <div v-for="item in clients" :key="item.name"
                                    class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50">
                                    <div
                                        class="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                                        <component :is="item.icon"
                ...
                <Popover class="relative">
                    ...
                    <transition enter-active-class="transition ease-out duration-200"
                        ...
                        <PopoverPanel
                            class="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5">
                            <div class="p-4">
                                <div v-for="item in factures" :key="item.name"
                                    class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50">
                                    <div
                                        class="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                                        <component :is="item.icon"
...
<script setup>
    ...
    const accounts = [{
            name: 'Liste',
            description: 'Affiche la liste des acomptes en cours',
            href: '/account',
            icon: ChartBarIcon
        },
        {
            name: 'Créer',
            description: "Création d'un nouvel acompte",
            href: '/account/create',
            icon: ChartBarIcon,
        },
    ]
    ...
    const stocks = [{
        name: 'Stock',
        description: 'Affiche le stock en magasin',
        href: '/stock',
        icon: ArchiveBoxIcon
    }]
